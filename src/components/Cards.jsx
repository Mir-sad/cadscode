...
const Cards = () => {
  return (
    <Container className='mt-5' style={{display:"flex", flexDirection:"column", justifyContent:"center", textAlign:"center", alignItems:"center"}}>
        <div className='row'>
        ...
        <Row className='mt-5' style={{display:"flex", justifyContent:"space-between", alignItems:"center"}}>
            {CardsData.map((data) => {
                return (
                 <Card style={{ width: '20rem', marginLeft:"20px", border:"none  " }}>
